...
recipes.addShaped(<scalinghealth:healingitem> * 2, [[<ore:paper>, <ore:paper>, <ore:paper>], [<ore:string>, <ore:blockWool>, <ore:string>]]);
recipes.addShaped(<scalinghealth:healingitem> * 3, [[<ore:paper>, <ore:paper>, <ore:paper>], [<scalinghealth:heartdust:0>, <scalinghealth:heartdust:0>, <scalinghealth:heartdust:0>]]);
...
recipes.addShaped(<roughtweaks:bandage> * 1, [[null, <roughtweaks:salve>, null],[<ore:blockWool>, <ore:string>, <ore:blockWool>]]);

recipes.addShaped(<firstaid:bandage> * 3, [[<ore:blockWool>, <ore:string>, <ore:blockWool>], [null, <roughtweaks:salve>, null]]);
